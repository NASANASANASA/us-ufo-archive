...
function buildInteractiveHome(lang, template) {
  ...
  return template
    ...
    .replace(/(<div class="showcase-dots"[^>]*><\/div>\s*<\/div>)\s*<\/div>\s*(?=<\/section>)/g, '$1\n    ')
    .replace(/\s*<div class="showcase-frame">\s*/g, '\n')
    ...
    .replace(/\s*<meta name="theme-color" content="[^"]+">\s*/g, '\n')
